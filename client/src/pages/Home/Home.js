          ...
          <div className={styles.container}>
              ...
              <div className={styles.cardContainer}>
                <div className={styles.card}>
                  ...
                  <p>
                    ...
                    business name ideas from world's largest community of naming experts.
                ...
                <div className={styles.card}>
                  ...
                  <p>
                    ...
                    ensure that you receive more ideas from our top-quality creatives, and
                    Gamification best practices ensure two-way communication throughout
                    your contest.
                  </p>
                </div>
                <div className={styles.card}>
                  ...
                  <p>
                    Squadhelp's high end Audience Testing service allows you to poll your
                    target demographics to get unbiased feedback on your favorite names.
                    Also receive Trademark support from our team of Licensed Trademark
            ...
            <div className={styles.headerBar}>
              ...
              <p className={styles.blueUnderline}>
                Not interested in launching a contest? Purchase a name instantly from our
                hand-picked collection of premium names. Price includes a complimentary
                Trademark Report, a Domain name as well as a Logo design
              </p>
            </div>
            <SlideBar
